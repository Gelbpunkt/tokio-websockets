...
- SIMD support for accelerated UTF-8 validation
...
- The `simd` feature flag is deprecated and has no effect
- The `nightly` feature when using a nightly compiler will enable additional optimizations
